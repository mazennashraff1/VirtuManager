...
class ListRunningContainersPage:
    ...
    def load_containers(self):
        ...
        for i, cont in enumerate(containers):
            ...
            ctk.CTkLabel(self.scroll_frame, text=cont["ID"], text_color="white").grid(row=row, column=0, **padding, sticky="w")
            ctk.CTkLabel(self.scroll_frame, text=cont["Name"], text_color="white").grid(row=row, column=1, **padding, sticky="w")
            ctk.CTkLabel(self.scroll_frame, text=cont["Status"], text_color="white").grid(row=row, column=2, **padding, sticky="w")
            ctk.CTkLabel(self.scroll_frame, text=cont["Image"], text_color="white").grid(row=row, column=3, **padding, sticky="w")
    ...
    def run_container(self, id):
        ...
        def action():
            ...
            self.window.after(0, lambda: messagebox.showinfo("Info", msg) if res else messagebox.showerror("Error", msg))
            self.refresh()
